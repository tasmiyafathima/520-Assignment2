...
import importlib
mod = importlib.import_module('outputs.llama3_SelfDebug.word_frequency_counter')
from outputs.llama3_SelfDebug.word_frequency_counter import word_frequency_counter
