...
import importlib
mod = importlib.import_module('outputs.deepseek_SelfDebug.is_balanced_parentheses')
from outputs.deepseek_SelfDebug.is_balanced_parentheses import is_balanced_parentheses
