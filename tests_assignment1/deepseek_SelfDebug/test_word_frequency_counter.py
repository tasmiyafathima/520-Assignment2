...
import importlib
mod = importlib.import_module('outputs.deepseek_SelfDebug.word_frequency_counter')
from outputs.deepseek_SelfDebug.word_frequency_counter import word_frequency_counter
