...
import importlib
mod = importlib.import_module('outputs.llama3_CoT.reverse_words_in_sentence')
from outputs.llama3_CoT.reverse_words_in_sentence import reverse_words_in_sentence
