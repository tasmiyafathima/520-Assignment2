...
import importlib
mod = importlib.import_module('outputs.deepseek_CoT.reverse_words_in_sentence')
from outputs.deepseek_CoT.reverse_words_in_sentence import reverse_words_in_sentence
